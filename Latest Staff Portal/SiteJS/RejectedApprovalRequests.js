var links = [
    ...
    { text: 'Imprest Surrender Requisition List', url: '/ImprestSurrender/ImprestSurrenderRequisitionList' },
    ...
    { text: 'My Appraisal List', url: '/Appraisal/MyAppraisalList' },
    { text: 'My Review Appraisal List', url: '/Appraisal/MyReviewAppraisalList' },
    ...
    { text: 'PCA Approved List', url: '/PCA/PCAApprovedList' },
