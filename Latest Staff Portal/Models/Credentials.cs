...
namespace Latest_Staff_Portal.Models
{
    public class Credentials
    {
        ...
        public static HttpWebResponse GetOdataData(string page)
        {
            ...
            var Url = ConfigurationManager.AppSettings["W_PWD"];
            var httpWebRequest =
        ...
        public static string ResetPassword(string username, string newpass)
        {
            ...
            try
            {
                ...
                if (username.Contains(@"\\"))
                    ...
                    UName = username.Trim();
                var AdminAccountName = ConfigurationManager.AppSettings["AD_USER"];
                var AdminPassword = ConfigurationManager.AppSettings["ADW_PWD"];
