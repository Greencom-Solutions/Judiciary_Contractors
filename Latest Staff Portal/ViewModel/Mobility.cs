...
namespace Latest_Staff_Portal.ViewModel
{
    public class EmpTransferReqList
    {
        ...
        public string MobilityRemarks { get; set; }
        public List<SelectListItem> ListOfGeographicalLocation { get; set; }
        ...
        public string HeadofMobilityRemarks { get; set; }
        public string DirectorRemarks { get; set; }
        public string CRJApproval { get; set; }
        public string CRJRemarks { get; set; }
    }
